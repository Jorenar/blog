...
> "Why should I even bother with C?", "C is old and obsolete!" ...

Have you heard such words? Well, I have. Countless of times, be it in direct
conversation or on a forum. In my humble opinion learning C is really valuable
experience, so in this not too long text I hope to show you what I think makes
C great.
...
And if it there is a need, popular C compilers offers you the option to level
...
to become obscure when, in the moment I'm writing those words, there is planned
new standard revision (working name: C2x) with preview release from last month!
...
* [A beginners' guide _away_ from `scanf()`](https://web.archive.org/web/20201112034702/http://sekrit.de/webdocs/c/beginners-guide-away-from-scanf.html)
