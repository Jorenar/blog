---
layout: post
title:  "Best aspects of C and simultaneously perhaps its drawbacks"
redirect_from:
...
Four years ago I've authored a post titled "Best aspects of C language".
Initially I contrasted it very weakly with some drawback, but later
removed that part as I decided to write a dedicated for them. Well...
at this point, being richer with more experience, it's best to rewrite
both together anew.

So without further ado, a subjective list of best aspects of the C language,
which paradoxically might as well be its biggest flaws!

## Spirit of C

A principle present in committee charter documents, beginning with
[C99's N444](https://www.open-std.org/jtc1/sc22/wg14/www/docs/historic/n444.htm),
through [C11's N1250](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n1250.pdf),
up to [C23's N2611](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n2611.htm).
[The latest charter](https://www.open-std.org/jtc1/sc22/wg14/www/docs/n3280.htm)
still contains all those sentiments, but broke and remixed them into their own
principles, with proper descriptions.

The following quote comes from document [C99RationaleV5.10](http://www.open-std.org/jtc1/sc22/wg14/www/C99RationaleV5.10.pdf):
...
The charter for C11 added another point:

> (f) Make support for safety and security demonstrable.

While the value behind those phrases is quite apparent without further
explanation, not everything survived the trial of time; especially:

> _Trust the programmer_, as a goal, is outdated in respect to the security and
> safety programming communities. While it should not be totally disregarded
> as a facet of the spirit of C, the C1X version of the C Standard should take
> into account that programmers need the ability to check their work.

History shows that religiously adhering to outdated values never is a good idea,
but as I've mentioned in the first paragraph of this section, latest charter
was an occasion for deeper contemplation what they actually mean and how are
relevant today. I think it's going for the better.

## Standard, or: not the C language, but C dialects

The C programming language is defined basically only by a document published
by International Organization for Standardization every few years. Contrary
to languages like Python, Rust or Java, there is no particular implementation
